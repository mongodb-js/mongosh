...
import { RemoteMongoClient, StitchAppClient } from 'mongodb-stitch-browser-sdk';
declare class StitchBrowserTransport implements Transport {
    readonly stitchTransport: StitchTransport<StitchAppClient, RemoteMongoClient>;
    static fromAppId(stitchAppId: string, serviceName: string): Promise<StitchBrowserTransport>;
