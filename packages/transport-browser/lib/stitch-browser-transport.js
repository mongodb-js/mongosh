 ...
 */
var StitchBrowserTransport = /** @class */ (function () {
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, client.auth.loginWithCredential(new mongodb_stitch_browser_sdk_1.AnonymousCredential())];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3:
                        ...
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/, new StitchBrowserTransport(client, serviceName)];
                }
            });
        });
    };
