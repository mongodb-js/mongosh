...
describe('Bulk API', () => {
  describe('Bulk', () => {
    ...
    describe('commands', () => {
      ...
      beforeEach(() => {
        ...
        innerStub.s = { batches: [1, 2, 3], currentBatch: 4 };
        bulk = new Bulk(collection, innerStub);
      });
      describe('insert', () => {
      ...
      describe('tojson', () => {
        it('returns the batches length + currentBatch?', () => {
      ...
      describe('find', () => {
        ...
        it('returns new BulkFindOp with arg', async() => {
          ...
          expect(res._innerFind).to.deep.equal({ driverFindOp: 1 });
        });
  ...
  describe('BulkFindOp', () => {
    describe('help', () => {
      const apiClass: any = new BulkFindOp({}, {} as any);
      it('calls help function', async() => {
        expect((await apiClass.help()[asShellResult]()).type).to.equal('Help');
        expect((await apiClass.help[asShellResult]()).type).to.equal('Help');
      });
    ...
    describe('commands', () => {
      ...
      describe('remove', () => {
        it('calls innerBulkOp.remove and returns parent', () => {
          bulkFindOp.remove();
        ...
        it('throws if innerBulkOp.remove throws', async() => {
          const expectedError = new Error();
      ...
      describe('removeOne', () => {
        it('calls innerBulkOp.removeOne and returns parent', () => {
        ...
        it('throws if innerBulkOp.removeOne throws', async() => {
          const expectedError = new Error();
      ...
      describe('upsert', () => {
        it('calls innerBulkOp.upsert and returns parent', () => {
          bulkFindOp.upsert();
      ...
      describe('update', () => {
        it('calls innerBulkOp.update and returns parent', () => {
        ...
        it('throws if innerBulkOp.update throws', async() => {
          const expectedError = new Error();
      ...
      describe('updateOne', () => {
        it('calls innerBulkOp.updateOne and returns parent', () => {
        ...
        it('throws if innerBulkOp.updateOne throws', async() => {
          const expectedError = new Error();
      ...
      describe('replaceOne', () => {
        it('calls innerBulkOp.replaceOne and returns parent', () => {
          bulkFindOp.replaceOne({ replaceOneDoc: 1 });
          expect(innerStub.replaceOne).to.have.been.calledWith({ replaceOneDoc: 1 });
          expect(bulk._batchCounts.nUpdateOps).to.equal(1);
        });

        it('calls innerBulkOp.replaceOne and returns parent when hint set', () => {
          bulkFindOp.hint({ hint: 1 });
          bulkFindOp.replaceOne({ replaceOneDoc: 1 });
        ...
        it('throws if innerBulkOp.replaceOne throws', async() => {
          const expectedError = new Error();
