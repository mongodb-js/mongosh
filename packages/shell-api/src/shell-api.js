...
Collection.prototype.drop.help = () => new Help({ 'help': 'shell-api.classes.Collection.help.attributes.drop.example', 'docs': 'shell-api.classes.Collection.help.attributes.drop.link', 'attr': [{ 'description': 'shell-api.classes.Collection.help.attributes.drop.description' }] });
Collection.prototype.drop.serverVersions = ['0.0.0', '4.4.0'];
Collection.prototype.drop.topologies = [0, 1, 2];
Collection.prototype.drop.returnsPromise = true;
Collection.prototype.drop.returnType = 'unknown';

Collection.prototype.getFullName.help = () => new Help({ 'help': 'shell-api.classes.Collection.help.attributes.getFullName.example', 'docs': 'shell-api.classes.Collection.help.attributes.getFullName.link', 'attr': [{ 'description': 'shell-api.classes.Collection.help.attributes.getFullName.description' }] });
Collection.prototype.getFullName.serverVersions = ['0.0.0', '4.4.0'];
Collection.prototype.getFullName.topologies = [0, 1, 2];
Collection.prototype.getFullName.returnsPromise = false;
Collection.prototype.getFullName.returnType = 'unknown';

Collection.prototype.getName.help = () => new Help({ 'help': 'shell-api.classes.Collection.help.attributes.getName.example', 'docs': 'shell-api.classes.Collection.help.attributes.getName.link', 'attr': [{ 'description': 'shell-api.classes.Collection.help.attributes.getName.description' }] });
Collection.prototype.getName.serverVersions = ['0.0.0', '4.4.0'];
Collection.prototype.getName.topologies = [0, 1, 2];
Collection.prototype.getName.returnsPromise = false;
Collection.prototype.getName.returnType = 'unknown';

Collection.prototype.exists.help = () => new Help({ 'help': 'shell-api.classes.Collection.help.attributes.exists.example', 'docs': 'shell-api.classes.Collection.help.attributes.exists.link', 'attr': [{ 'description': 'shell-api.classes.Collection.help.attributes.exists.description' }] });
Collection.prototype.exists.serverVersions = ['0.0.0', '4.4.0'];
Collection.prototype.exists.topologies = [0, 1, 2];
Collection.prototype.exists.returnsPromise = true;
Collection.prototype.exists.returnType = 'unknown';

Collection.prototype.renameCollection.help = () => new Help({ 'help': 'shell-api.classes.Collection.help.attributes.renameCollection.example', 'docs': 'shell-api.classes.Collection.help.attributes.renameCollection.link', 'attr': [{ 'description': 'shell-api.classes.Collection.help.attributes.renameCollection.description' }] });
Collection.prototype.renameCollection.serverVersions = ['0.0.0', '4.4.0'];
Collection.prototype.renameCollection.topologies = [0, 1, 2];
Collection.prototype.renameCollection.returnsPromise = true;
Collection.prototype.renameCollection.returnType = 'unknown';

Collection.prototype.runCommand.help = () => new Help({ 'help': 'shell-api.classes.Collection.help.attributes.runCommand.example', 'docs': 'shell-api.classes.Collection.help.attributes.runCommand.link', 'attr': [{ 'description': 'shell-api.classes.Collection.help.attributes.runCommand.description' }] });
Collection.prototype.runCommand.serverVersions = ['0.0.0', '4.4.0'];
