...
var ECMAScriptLexer_1 = __importDefault(require("./antlr/ECMAScriptLexer"));
var ECMAScriptParser_1 = __importDefault(require("./antlr/ECMAScriptParser"));
var ECMAScriptVisitor_1 = __importDefault(require("./antlr/ECMAScriptVisitor"));
var ShellTypes = {};
var AsyncWriter = (function (_super) {
    ...
    return AsyncWriter;
}(ECMAScriptVisitor_1.default.ECMAScriptVisitor));
...
var compileEcma = function (input, types, symbols) {
    ...
    var lexer = new ECMAScriptLexer_1.default.ECMAScriptLexer(chars);
    lexer.strictMode = false;
    var tokens = new antlr4_1.default.CommonTokenStream(lexer);
    var parser = new ECMAScriptParser_1.default.ECMAScriptParser(tokens);
...
exports.default = compileEcma;
//# sourceMappingURL=async-rewriter.js.map