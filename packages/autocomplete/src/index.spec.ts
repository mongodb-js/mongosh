...
describe('completer.completer', function () {
  ...
  context('when context is aggregation query', function () {
    it('returns all suggestions', async function () {
      ...
      expect(await completer(standalone440, i)).to.deep.equal([
        [
          'db.shipwrecks.aggregate([{$abs',
          'db.shipwrecks.aggregate([{$accumulator',
          'db.shipwrecks.aggregate([{$add',
          'db.shipwrecks.aggregate([{$allElementsTrue',
          'db.shipwrecks.aggregate([{$and',
          'db.shipwrecks.aggregate([{$anyElementTrue',
          'db.shipwrecks.aggregate([{$arrayElemAt',
          'db.shipwrecks.aggregate([{$arrayToObject',
          'db.shipwrecks.aggregate([{$binarySize',
          'db.shipwrecks.aggregate([{$bsonSize',
          'db.shipwrecks.aggregate([{$ceil',
          'db.shipwrecks.aggregate([{$cmp',
          'db.shipwrecks.aggregate([{$concat',
          'db.shipwrecks.aggregate([{$concatArrays',
          'db.shipwrecks.aggregate([{$cond',
          'db.shipwrecks.aggregate([{$dateFromParts',
          'db.shipwrecks.aggregate([{$dateFromString',
          'db.shipwrecks.aggregate([{$dateToParts',
          'db.shipwrecks.aggregate([{$dateToString',
          'db.shipwrecks.aggregate([{$dayOfMonth',
          'db.shipwrecks.aggregate([{$dayOfWeek',
          'db.shipwrecks.aggregate([{$dayOfYear',
          'db.shipwrecks.aggregate([{$dateToString',
          'db.shipwrecks.aggregate([{$divide',
          'db.shipwrecks.aggregate([{$eq',
          'db.shipwrecks.aggregate([{$exp',
          'db.shipwrecks.aggregate([{$filter',
          'db.shipwrecks.aggregate([{$first',
          'db.shipwrecks.aggregate([{$floor',
          'db.shipwrecks.aggregate([{$function',
          'db.shipwrecks.aggregate([{$gt',
          'db.shipwrecks.aggregate([{$gte',
          'db.shipwrecks.aggregate([{$hour',
          'db.shipwrecks.aggregate([{$ifNull',
          'db.shipwrecks.aggregate([{$in',
          'db.shipwrecks.aggregate([{$indexOfArray',
          'db.shipwrecks.aggregate([{$indexOfBytes',
          'db.shipwrecks.aggregate([{$indexOfCP',
          'db.shipwrecks.aggregate([{$isArray',
          'db.shipwrecks.aggregate([{$isNumber',
          'db.shipwrecks.aggregate([{$isoDayOfWeek',
          'db.shipwrecks.aggregate([{$isoWeek',
          'db.shipwrecks.aggregate([{$isoWeekYear',
          'db.shipwrecks.aggregate([{$last',
          'db.shipwrecks.aggregate([{$let',
          'db.shipwrecks.aggregate([{$literal',
          'db.shipwrecks.aggregate([{$lt',
          'db.shipwrecks.aggregate([{$lt',
          'db.shipwrecks.aggregate([{$ln',
          'db.shipwrecks.aggregate([{$log',
          'db.shipwrecks.aggregate([{$log10',
          'db.shipwrecks.aggregate([{$map',
          'db.shipwrecks.aggregate([{$mergeObjects',
          'db.shipwrecks.aggregate([{$meta',
          'db.shipwrecks.aggregate([{$millisecond',
          'db.shipwrecks.aggregate([{$minute',
          'db.shipwrecks.aggregate([{$mod',
          'db.shipwrecks.aggregate([{$month',
          'db.shipwrecks.aggregate([{$multiply',
          'db.shipwrecks.aggregate([{$new',
          'db.shipwrecks.aggregate([{$not',
          'db.shipwrecks.aggregate([{$objectToArray',
          'db.shipwrecks.aggregate([{$or',
          'db.shipwrecks.aggregate([{$pow',
          'db.shipwrecks.aggregate([{$range',
          'db.shipwrecks.aggregate([{$reduce',
          'db.shipwrecks.aggregate([{$regexFind',
          'db.shipwrecks.aggregate([{$regexFindAll',
          'db.shipwrecks.aggregate([{$regexMatch',
          'db.shipwrecks.aggregate([{$replaceAll',
          'db.shipwrecks.aggregate([{$replaceOne',
          'db.shipwrecks.aggregate([{$reverseArray',
          'db.shipwrecks.aggregate([{$second',
          'db.shipwrecks.aggregate([{$setDifference',
          'db.shipwrecks.aggregate([{$setEquals',
          'db.shipwrecks.aggregate([{$setIntersection',
          'db.shipwrecks.aggregate([{$setIsSubset',
          'db.shipwrecks.aggregate([{$setUnion',
          'db.shipwrecks.aggregate([{$size',
          'db.shipwrecks.aggregate([{$slice',
          'db.shipwrecks.aggregate([{$split',
          'db.shipwrecks.aggregate([{$sqrt',
          'db.shipwrecks.aggregate([{$strcasecmp',
          'db.shipwrecks.aggregate([{$strLenBytes',
          'db.shipwrecks.aggregate([{$strLenCP',
          'db.shipwrecks.aggregate([{$substr',
          'db.shipwrecks.aggregate([{$substrBytes',
          'db.shipwrecks.aggregate([{$substrCP',
          'db.shipwrecks.aggregate([{$subtract',
          'db.shipwrecks.aggregate([{$switch',
          'db.shipwrecks.aggregate([{$toHashedIndexKey',
          'db.shipwrecks.aggregate([{$toLower',
          'db.shipwrecks.aggregate([{$toUpper',
          'db.shipwrecks.aggregate([{$trunc',
          'db.shipwrecks.aggregate([{$type',
          'db.shipwrecks.aggregate([{$week',
          'db.shipwrecks.aggregate([{$year',
          'db.shipwrecks.aggregate([{$zip',
          'db.shipwrecks.aggregate([{$convert',
          'db.shipwrecks.aggregate([{$ltrim',
          'db.shipwrecks.aggregate([{$rtrim',
          'db.shipwrecks.aggregate([{$toBool',
          'db.shipwrecks.aggregate([{$toDate',
          'db.shipwrecks.aggregate([{$toDecimal',
          'db.shipwrecks.aggregate([{$toDouble',
          'db.shipwrecks.aggregate([{$toInt',
          'db.shipwrecks.aggregate([{$toLong',
          'db.shipwrecks.aggregate([{$toObjectId',
          'db.shipwrecks.aggregate([{$toString',
          'db.shipwrecks.aggregate([{$trim',
          'db.shipwrecks.aggregate([{Code',
          'db.shipwrecks.aggregate([{ObjectId',
          'db.shipwrecks.aggregate([{Binary',
          'db.shipwrecks.aggregate([{DBRef',
          'db.shipwrecks.aggregate([{Timestamp',
          'db.shipwrecks.aggregate([{NumberInt',
          'db.shipwrecks.aggregate([{NumberLong',
          'db.shipwrecks.aggregate([{NumberDecimal',
          'db.shipwrecks.aggregate([{MaxKey',
          'db.shipwrecks.aggregate([{MinKey',
          'db.shipwrecks.aggregate([{ISODate',
          'db.shipwrecks.aggregate([{RegExp',
          'db.shipwrecks.aggregate([{$addFields',
          'db.shipwrecks.aggregate([{$bucket',
          'db.shipwrecks.aggregate([{$bucketAuto',
          'db.shipwrecks.aggregate([{$changeStream',
          'db.shipwrecks.aggregate([{$collStats',
          'db.shipwrecks.aggregate([{$count',
          'db.shipwrecks.aggregate([{$currentOp',
          'db.shipwrecks.aggregate([{$facet',
          'db.shipwrecks.aggregate([{$geoNear',
          'db.shipwrecks.aggregate([{$graphLookup',
          'db.shipwrecks.aggregate([{$group',
          'db.shipwrecks.aggregate([{$indexStats',
          'db.shipwrecks.aggregate([{$limit',
          'db.shipwrecks.aggregate([{$listLocalSessions',
          'db.shipwrecks.aggregate([{$lookup',
          'db.shipwrecks.aggregate([{$match',
          'db.shipwrecks.aggregate([{$merge',
          'db.shipwrecks.aggregate([{$out',
          'db.shipwrecks.aggregate([{$project',
          'db.shipwrecks.aggregate([{$redact',
          'db.shipwrecks.aggregate([{$replaceRoot',
          'db.shipwrecks.aggregate([{$replaceWith',
          'db.shipwrecks.aggregate([{$sample',
          'db.shipwrecks.aggregate([{$set',
          'db.shipwrecks.aggregate([{$skip',
          'db.shipwrecks.aggregate([{$sort',
          'db.shipwrecks.aggregate([{$sortByCount',
