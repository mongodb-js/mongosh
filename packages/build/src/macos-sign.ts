 ...
 */
const notarize = (bundleId: string, artifact: string, user: string, password: string): Promise<void> => {
  return nodeNotarize({
 ...
 */
const sign = (executable: string, identity: string, entitlementsFile: string): Promise<any> => {
