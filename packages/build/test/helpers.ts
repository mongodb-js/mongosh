...
export const dummyConfig: Config = Object.freeze({
  ...
  downloadCenterAwsKeyConfig: 'downloadCenterAwsKey',
  downloadCenterAwsSecretConfig: 'downloadCenterAwsSecret',
  downloadCenterAwsKeyArtifacts: 'downloadCenterAwsKey',
