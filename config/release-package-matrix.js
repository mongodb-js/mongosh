...
exports.RELEASE_PACKAGE_MATRIX = [
  {
    ...
    packages: [
      { name: 'darwin-x64', description: 'MacOS x64 (10.14+)', packageOn: 'darwin', smokeTestKind: 'macos', serverLikeTargetList: ['macos'] }
    ]
  },
  {
  ...
  },
  {
    ...
    packages: [
      { name: 'linux-ppc64le', description: 'Linux ppc64le', packageOn: 'linux_package', smokeTestKind: 'none', serverLikeTargetList: [...rhel81AndAbove] },
      { name: 'rpm-ppc64le', description: 'RHEL / CentOS (7+) ppc64le', packageOn: 'linux_package', smokeTestKind: 'rpmextract', serverLikeTargetList: [...rhel81AndAbove] }
    ]
  },
  {
    ...
    packages: [
      { name: 'linux-s390x', description: 'Linux s390x', packageOn: 'linux_package', smokeTestKind: 'none', serverLikeTargetList: [...rhel72AndAbove] },
      { name: 'rpm-s390x', description: 'RHEL / CentOS (7+) s390x', packageOn: 'linux_package', smokeTestKind: 'rpmextract', serverLikeTargetList: [...rhel72AndAbove] }
    ]
  },
  {
    ...
    packages: [
      { name: 'win32-x64', description: 'Windows x64 (8.1+)', packageOn: 'win32', smokeTestKind: 'ssh', serverLikeTargetList: ['windows'] },
      { name: 'win32msi-x64', description: 'Windows x64 (8.1+)', packageOn: 'win32', smokeTestKind: 'ssh', serverLikeTargetList: ['windows'] }
    ]
  }
];
