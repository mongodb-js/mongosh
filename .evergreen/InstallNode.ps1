...
$scriptDir = (Get-Item $MyInvocation.MyCommand.Path).Directory.FullName
Invoke-Expression -Command ". $scriptDir/RetryWithBackoff.ps1"
...
Retry-With-Backoff -MaxAttempt 5 -Timeout (New-TimeSpan -Seconds 2) -Label "Downloading nodejs" -Command {
